...
/// </summary>
public class GameRoomManager : Photon.MonoBehaviour
{
	...
	public virtual void Start()
	{
		...
		GameObject.Find("loadingText").GetComponent<Text>().text = XmlReader.GetInnerText(xmlDocument, languageManager.currentLanguage, "Text_Loading");
	}
