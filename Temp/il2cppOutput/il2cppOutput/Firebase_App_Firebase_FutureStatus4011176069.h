...
struct  FutureStatus_t4011176069 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(FutureStatus_t4011176069, ___value___1)); }
