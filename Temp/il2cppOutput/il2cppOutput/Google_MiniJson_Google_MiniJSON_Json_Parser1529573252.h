...
struct  Parser_t1529573252  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_json_0() { return static_cast<int32_t>(offsetof(Parser_t1529573252, ___json_0)); }
