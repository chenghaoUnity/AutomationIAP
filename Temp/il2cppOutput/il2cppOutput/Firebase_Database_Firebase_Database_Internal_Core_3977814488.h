...
struct  TokenChangeListener79_t3977814488  : public Il2CppObject
{
public:
	// Firebase.Database.Internal.Core.Repo Firebase.Database.Internal.Core.Repo/TokenChangeListener79::_enclosing
	Repo_t1244308462 * ____enclosing_0;

public:
	inline static int32_t get_offset_of__enclosing_0() { return static_cast<int32_t>(offsetof(TokenChangeListener79_t3977814488, ____enclosing_0)); }
